...
for (const marker of ["removedTrackingCannotNotifyEvenWhenStaleWorkStillExecutes", "activeNotifications", "contains(\"你追踪的物品到复查时间了\")", "contentIntent.send(", "MODE_BACKGROUND_ACTIVITY_START_ALLOWED", "awaitOpenedCardId", "MainActivity.EXTRA_CARD_ID", "doesNotContain(notificationId)", "doesNotContain(\"隐私测试物品\")"]) {
  check(
