...
check(
  mediaRepository.includes('stableId("staging:$value")') &&
    ...
    mediaRepository.includes("contentDuplicate.analysisState != AnalysisState.NEVER_ANALYZE.name") &&
  ...
  "Explicit imports are URI-addressed, can bypass content suppression, or lack API 34 regression evidence"
);
check(
