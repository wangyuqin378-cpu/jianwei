...
try {
    ...
    if ($LASTEXITCODE -ne 0 -or $schemaCount -ne "17") { throw "Expected seventeen applied PostgreSQL migrations, found: $schemaCount" }
    ...
    if ($tests -lt 19 -or $failedTests -ne 0 -or $pendingTests -ne 0) {
